...
# go to the bar on the left with the bug and play on it "Run and Debug" setup a django one, press play or restart
# go to http://localhost:8000/regserve/data/students/   when the server is running
